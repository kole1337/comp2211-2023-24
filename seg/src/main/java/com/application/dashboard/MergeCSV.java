...
public class MergeCSV {
    public static void main(String[] args) {
        ...
        String file2 = "/2_week_campaign_2/impression_log.csv"; // Path to the second CSV file
        String outputFile = "/2_week_campaign_2/merged.csv"; // Output file path for merged CSV
        ...
        Map<String, String[]> data2 = readCSV(inputStream2);
    ...
    private static Map<String, String[]> readCSV(InputStream stream1) {
        Map<String, String[]> data = new HashMap<>();
        try (BufferedReader br = new BufferedReader(new InputStreamReader(stream1))) {
            String line;
